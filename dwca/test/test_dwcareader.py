...
class TestDescriptor(unittest.TestCase):
    ...
    def test_exposes_core_type(self):
        """Test that it exposes the Archive Core Type as core_type"""
        ...
        with DwCAReader(BASIC_ARCHIVE_PATH) as dwca:
            ...
            self.assertEqual(descriptor.core_type, 'http://rs.tdwg.org/dwc/terms/Occurrence')
            # Check that shortcuts also work
            self.assertEqual(descriptor.core_type, qn('Occurrence'))
    ...
    def test_exposes_core_terms(self):
        with DwCAReader(EXTENSION_ARCHIVE_PATH) as star_dwca:
            ...
            self.assertEqual(6, len(descriptor.core_terms))
            ...
            self.assertEqual(fields, descriptor.core_terms)
